...
{
    private MedEvent(Guid id, Guid userId, Guid historyId, string title, string description, 
    ...
    public static (MedEvent medEvent, string Error) Create(Guid id, Guid userId, Guid historyId, string title, string description,
        DateTime visitTime, string direction, string doctorName,
        string doctorPhone, string clinicName, string clinicPhone, string address)
    {
        ...
        var medEvent = new MedEvent(id, userId, historyId, title, description, visitTime, direction, doctorName, doctorPhone, clinicName, clinicPhone, address);
        return (medEvent, error);
    }
}
